  ...
  const Runout = () => {
    if (player1 === 1) {
      ...
      setLastbatsman(
        lastbatsman +
          "\n" +
          ` | ${player1name} : ${runs1}(${balls1}) [ Strike Rate : ${strikerate} ]`
      );
      setPlayertocrease(playertocrease + 1);
      setPlayer1name(`Player ${playertocrease + 1}`);
      setRuns1(0);
      ...
      setLastbatsman(
        lastbatsman +
          ` | ${player2name} : ${runs2}(${balls2}) [ Strike Rate : ${strikerate} ]`
      );
      setPlayertocrease(playertocrease + 1);
      setPlayer2name(`Player ${playertocrease + 1}`);
      setRuns2(0);
        ...
        <div className="container border border-primary my-5">
          ...
          <div className="container border border-primary my-2 p-2">
            ...
            <div className="container border border-success w-50 p-2 mb-2">
              ...
              <div className="border border-primary m-1 p-2 d-flex justify-content-around">
                <div>
                  <h6>
                    {player1name}
                    {player1 > 0 ? "*" : "_"}
